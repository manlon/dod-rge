...
#define RUBY_PLATFORM "mipsallegrexel-elf"
#define RUBY_ARCHLIB "/usr/local/lib/ruby/1.8/mipsallegrexel-elf"
#define RUBY_SITE_ARCHLIB "/usr/local/lib/ruby/site_ruby/1.8/mipsallegrexel-elf"
